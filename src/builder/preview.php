...
$detailsLabel       = htmlspecialchars($lang['detailsLabel']       ?? 'Additional Details');
$detailsPlaceholder = htmlspecialchars($lang['detailsPlaceholder'] ?? 'Describe any specific requirements, features, or deadlines.');
...
<div class="pv-step" id="pv-step-3" style="display:none;">
    ...
    <div class="pv-step-block">
        ...
        <div class="pv-field-group" style="margin-top:1.5rem;">
            <label class="pv-label"><?= $detailsLabel ?></label>
